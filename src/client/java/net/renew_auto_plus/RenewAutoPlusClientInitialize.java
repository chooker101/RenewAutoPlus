...
public class RenewAutoPlusClientInitialize implements ClientModInitializer {
    ...
    public static final EntityModelLayer FRILLED_BASILISK_MODEL_LAYER = new EntityModelLayer(new Identifier("renew_auto_plus", "frilled_basilisk"), "main");

    public static final Identifier ABACUS_SCREEN_LIST_PACKET_ID = new Identifier("renew_auto_plus", "abacus_screen_list_packet");
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(RenewAutoPlusInitialize.FRILLED_BASILISK_ENTITY, FrilledBasiliskEntityRenderer::new);
        EntityRendererRegistry.register(RenewAutoPlusInitialize.VOID_VILLAGER_ENTITY, VoidVillagerEntityRenderer::new);
        ...
        EntityModelLayerRegistry.registerModelLayer(FRILLED_BASILISK_MODEL_LAYER, FrilledBasiliskEntityModel::getTexturedModelData);

        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(), RenewAutoPlusInitialize.LETTUCE_BLOCK);
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(), RenewAutoPlusInitialize.WASTES_GLASS);

        registerClientPackets();
    }

    public void registerClientPackets() {
        ClientPlayNetworking.registerGlobalReceiver(ABACUS_SCREEN_LIST_PACKET_ID, new ListToAbacusScreenPlayChannelHandler());
    }
}
