...
public class RenewAutoPlusInitialize implements ModInitializer {
	...
	public static final Identifier AbacusStringPacketID = new Identifier("renew_auto_plus", "abacus_string_packet");
	public static final Identifier AbacusTransactPacketID = new Identifier("renew_auto_plus", "abacus_transact_packet");
	public static final Identifier CrateStringPacketID = new Identifier("renew_auto_plus", "crate_string_packet");
	...
	public void registerServerPackets() {
		ServerPlayNetworking.registerGlobalReceiver(AbacusStringPacketID, new StringToAbacusPlayChannelHandler());
		ServerPlayNetworking.registerGlobalReceiver(AbacusTransactPacketID, new TransactStallTradePlayChannelHandler());
		ServerPlayNetworking.registerGlobalReceiver(CrateStringPacketID, new StringToCratePlayChannelHandler());
	}
}
