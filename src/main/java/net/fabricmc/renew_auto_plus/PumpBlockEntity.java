    ...
    public final PropertyDelegate propertyDelegate = new PropertyDelegate(){
        ...
        public int get(int index) {
            switch (index) {
                ...
                case 2: {
                    return PumpBlockEntity.this.currentBreakingProgress;
                }
                case 3: {
                    return PumpBlockEntity.this.totalBreakingTime;
                }
            }
            return 0;
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                ...
                case 2: {
                    PumpBlockEntity.this.currentBreakingProgress = value;
                    break;
                }
                case 3: {
                    PumpBlockEntity.this.totalBreakingTime = value;
                    break;
                }
            }
        }
