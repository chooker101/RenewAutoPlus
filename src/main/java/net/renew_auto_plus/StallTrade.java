...
public class StallTrade {
    ...
    private boolean isAutoPurchase; //Should be broken out into child class
    ...
    public void setAutoPurchase(boolean purchase) {
        isAutoPurchase = purchase;
    }
    ...
    public void toPacket(PacketByteBuf buf) {
        ...
        buf.writeBoolean(this.isAutoPurchase());
    }
    ...
    public static StallTrade fromPacket(PacketByteBuf buf) {
        ...
        boolean isAutoPurchase = buf.readBoolean();
        ...
        stallTrade.setAutoPurchase(isAutoPurchase);
        return stallTrade;
    }
