...
public abstract class PublicProjectileEntity extends Entity {
    ...
    public Entity getOwner() {
        ...
        if (this.ownerUuid != null && this.method_48926() instanceof ServerWorld) {
            this.owner = ((ServerWorld)this.method_48926()).getEntity(this.ownerUuid);
            return this.owner;
        }
        return null;
    }
    ...
    public void onSpawnPacket(EntitySpawnS2CPacket packet) {
        ...
        Entity entity = this.method_48926().getEntityById(packet.getEntityData());
        if (entity != null) {
